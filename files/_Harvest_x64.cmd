...
echo.
echo Copying . . .
xcopy "%source%\Program Files (x86)\Microsoft.NET\*" "%target%\Microsoft.NET\" /cheriky >nul
...
xcopy "%source%\Windows\Microsoft.NET\Framework\v4.0.30319\*" "%target%\Framework\v4.0.30319\" /cheriky >nul
xcopy "%source%\Windows\Microsoft.NET\Framework64\v4.0.30319\*" "%target%\v4.0.30319\" /cheriky >nul
...
xcopy "%source%\Windows\SysWOW64\aspnet_counters.dll" "%target%\SysWOW64\" /chriky >nul
xcopy "%source%\Windows\SysWOW64\*_clr0400.dll" "%target%\SysWOW64\" /chriky >nul
xcopy "%source%\Windows\SysWOW64\en-US\dfshim.dll.mui" "%target%\SysWOW64\en-US\" /chriky >nul
copy "%~dp0NetFxMOF.inf" "%target%\inf\" >nul
copy "%~dp0Tasks_x64.txt" "%target%\Tasks.txt" >nul
echo.
echo Done.
echo Press any key to exit.
pause >nul
